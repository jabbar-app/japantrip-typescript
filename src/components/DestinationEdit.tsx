      ...
      .then(data => {
        if (data) {
          setForm({
            ...
            visitDurationHours: data.visitDurationHours?.toString() || '',
            ...
            ticketPriceYen: data.ticketPriceYen?.toString() || '',
            openHour: data.openHour || '',
            closeHour: data.closeHour || '',
            link_gmaps: data.link_gmaps || '',
            suitableForKids: !!data.suitableForKids,
            estimatedWalkMinutesFromPrevious: data.estimatedWalkMinutesFromPrevious?.toString() || ''
          })
        }
      })
      .catch(err => {
